  ...
  return (
    <div className="flex flex-col select-none h-full bg-white overflow-hidden">
      ...
      <p className="md:mt-10 mt-5 mb-3 ml-4 md:text-4xl font-semibold">
        Pourquoi choisir{" "}
        <span className="bg-[#f3cb65]/70 md:text-3xl ">Shirty</span> ?{" "}
      </p>
      <div className="flex items-center justify-around flex-wrap relative  md:py-5 overflow-hidden  md:bg-[#f3cb65]/50 md:mx-20 mb-2 ">
        <svg
        ...
        <div className="md:my-2 my-1 md:mx-2 mx-auto flex md:flex-row flex-col items-center bg-white/90 px-2 py-1 rounded-lg md:py-2 drop-shadow-lg  ">
          <img
            src="/icons/box-secured.png"
            alt=""
            className="md:max-h-32 max-h-20 md:border-r-2 md:pr-2 md:mr-2"
          />
          <p className="max-w-[250px] font-semibold md:text-base text-sm text-gray-800 text-center  ">
            Livraison sûr, votre produit vous sera livrer intacte
          </p>
        </div>

        <div className="md:my-2 my-1 flex md:flex-row flex-col items-center bg-white/90 px-2 py-1 rounded-lg md:py-2 drop-shadow-lg">
          <img
          ...
          />
          <p className="max-w-[250px] font-semibold md:text-base text-sm text-gray-800 text-center ">
            Excellente qualité d'impression qui vous garantira la réussite de
            votre produit
          </p>
        </div>
        <div className="md:my-2 my-1 flex md:flex-row flex-col items-center bg-white/90 px-2 py-1 rounded-lg md:py-2 drop-shadow-lg">
          <img
            src="/icons/shop.png"
            alt=""
            className="md:max-h-24 max-h-16 md:border-r-2 md:pr-2 md:mr-2"
          />
          <p className="max-w-[250px] font-semibold md:text-base text-sm text-gray-800 text-center ">
            Large sélection de produits que vous pouvez modifier a vos goûts et
            envies
          </p>
        </div>
        <div className="md:my-2 my-1 flex md:flex-row flex-col items-center bg-white/90 px-2 py-1 rounded-lg md:py-2 drop-shadow-lg">
          <img
            ...
            alt=""
            className="md:max-h-28 max-h-20 md:border-r-2 md:pr-2 md:mr-2"
          />
          <p className="max-w-[250px] font-semibold md:text-base text-sm text-gray-800 text-center ">
      ...
      <div className="flex md:flex-row flex-wrap flex-col items-center md:ml-20">
        <p className="py-1 md:px-2 px-1 m-1 text-center text-gray-800 md:text-sm text-xs font-semibold rounded-sm bg-[#f3cb65]/70 max-w-fit ">
          Découvrez aussi nos remises exclusives pour les étudiants et les
          commerçants{" "}
        </p>
        <p className="py-1 md:px-2 px-1 m-1 text-center text-gray-800 md:text-sm text-xs font-semibold rounded-sm bg-[#e0cfda]/70 max-w-fit ">
          Des codes promotionnels qui vous permettront d'économiser jusqu'à 25%
        </p>
        <p className="py-1 md:px-2 px-1 m-1 text-center text-gray-800 md:text-sm text-xs font-semibold rounded-sm bg-[#50d6d7]/70 max-w-fit ">
          Pas de minimum de commande
        </p>
      </div>

      {/* section design desktop */}
      <div className="lg:flex lg:items-center  lg:flex-wrap  sm:my-10   sm:mx-7  w-full relative hidden">
      ...
      <div className="lg:hidden flex flex-col items-center sm:flex-row mt-10">
      ...
      {/* shop desktop  */}
      <div className="lg:flex  relative hidden self-end border">
        <img src="/images/shop.png" alt="" className="max-w-[55rem]" />
        <div className="flex flex-col  absolute left-5 bottom-14 ">
          <p className="text-5xl font-semibold text-gray-800 mb-14 max-w-[250px] ">
            Ce que vous aimer porter
          </p>
          <p className="text-2xl   md:max-w-md">
          ...
          <button className="bg-rose-500 md:my-3 max-w-fit self-end text-xl z-40 text-white px-4 py-1  hover:bg-rose-600 rounded-full">
            Découvrir
          </button>
        </div>
      </div>
